          ...
          <div class="">
            ...
            <div class="row">
              <div class=" col-md-12 col-sm-12 col-xs-16 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Matricule number*</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <!--       <div class="control-label col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
